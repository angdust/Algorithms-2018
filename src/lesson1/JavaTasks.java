    ...
    static public void sortSequence(String inputName, String outputName) throws Exception {
        ...
        while ((line = bufferedReader.readLine()) != null) {
            ...
            if (table.containsKey(key)) {
                int value = table.get(Integer.parseInt(line));
        ...
        for (Integer key : table.keySet()) {
            if (maxRepeat < table.get(key)) {
                maxRepeat = table.get(key);
            }
        }
        for (Integer key : table.keySet()) {
            if (maxRepeat == table.get(key)) {
        ...
        for (Integer aResult : result) {
            if (aResult != minNumber) {
                bufferedWriter.write(aResult + "\n");
            }
        }
